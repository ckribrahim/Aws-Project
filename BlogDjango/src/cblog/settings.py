...
DATABASES = {
    'default': {
        ...
        'HOST': 'awsproject-rds.cb26y2oiomg7.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsproject-cptgrey-blog' # please enter your s3 bucket name
